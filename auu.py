...
def auth_callback(username: str, password: str) -> Optional[cl.AppUser]:
  ...
  """if (username, password) == ("admin", "Kasmo"):
  ...
  if (username, password) == ("admin", "Kasmo"):
    return cl.AppUser(username="admin", role="ADMIN", provider="credentials")
  elif (username, password) == ("user", "Kasmo@123"):
    return cl.AppUser(username="user", role="USER", provider="credentials")
  elif (username, password) == ("user1", "Kasmo@12"):
    return cl.AppUser(username="user1", role="USER1", provider="credentials")
  else:
    return None
